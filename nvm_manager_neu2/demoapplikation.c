...
int NVM_demoapplikation() {
    ...
    // Teste das lesen aus dem unbeschribenen Record durch SyncReadRecord
    ret = NVM_SyncReadRecord(&manager, &record);
    assert(ret == -1);
    printf("\033[0;32mlesen aus dem unbeschribenen Record durch SyncReadRecord: CHECK!\033[0;37m\n");
    ...
    printf("\033[0;32mHinzufügen von Records, bis kein Platz mehr im NVM-Speicher ist: CHECK!\033[0;37m\n");
